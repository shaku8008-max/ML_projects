...
IN_PATH = "data/processed/epl_cl_2526_features_v2_elo.csv"
OUT_PATH = "data/processed/epl_cl_2526_features_v3_form_elo.csv"
...
for idx, row in df.iterrows():
    ...
    home_hist = last_n(home)
    away_hist = last_n(away)
...
print(f"Saved combined features (ELO + form): {OUT_PATH}")
print(df.head(10))
